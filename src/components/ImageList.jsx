...
function ImageList() {
  ...
  useEffect(() => {
    fetch("https://img-review-be.onrender.com/api/images")
      .then((res) => res.json())
      .then(setImages);
  });

  const handleLike = (id) => {
    fetch(`https://img-review-be.onrender.com/api/images/${id}/like`, { method: "POST" });
  ...
  const handleComment = (id) => {
    ...
    if (!text) return;
    fetch(`https://img-review-be.onrender.com/api/images/${id}/comment`, {
      method: "POST",
